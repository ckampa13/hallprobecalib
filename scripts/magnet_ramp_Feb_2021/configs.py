...
pklfit_temp_regress_nmr = pkldir+'ramp_2021-02-24.nmr-lin-temp-regress-fits.pkl'
pklfit_temp_regress_hall = pkldir+'ramp_2021-02-24.hall-lin-temp-regress-fits.pkl'
pklfit_temp_regress_hall_w_nmr = pkldir+'ramp_2021-02-24.hall-from-nmr-lin-temp-regress-fits.pkl'
# LaTeX output
